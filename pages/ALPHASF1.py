...
class Chatbot:
    def __init__(self, llm="llama3.1:latest", embedding_model="all-mpnet-base-v2", vector_store=None):
    ...
    def set_setting(_arg, llm, embedding_model):
        ...
        Settings.embed_model = SentenceTransformerEmbedding(model_name=embedding_model)
    ...
    def load_data(_arg, vector_store=None):
        with st.spinner(text="Sedang memuat, sabar yaa."):
            ...
            parser = SimpleNodeParser.from_defaults(chunk_size=768)
        ...
        if vector_store is None:
            ...
            vector_store = QdrantVectorStore(client=client, collection_name="Sentence_Transf_jina")
